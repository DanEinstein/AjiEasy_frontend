...
if (quizForm) {
    quizForm.addEventListener('submit', async (e) => {
        ...
        toggleLoading(true, 'Generating quiz questions...');
        ...
        try {
            ...
            quizState.questions = Array.isArray(data) ? data : (data.questions || []);
...
function handleAnswer(selectedIndex, selectedBtn) {
    ...
    if (typeof correctAnswer === 'string' && correctAnswer.trim().match(/^[0-3]$/)) {
...
function showResults() {
    ...
    if (percentage >= 80) {
        ...
        scoreMessage.textContent = 'Keep learning! You got this! 💪';
    }
}
